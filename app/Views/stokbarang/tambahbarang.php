...
<div class="container-fluid">
    <h3 class="mb-5 text-gray-900">Tambah Data Obat</h3>
</div>

<div class="container">
    <div class="row">
        <div class="col-10">
            <form action="/stokbarang/save" method="post">
                <?= csrf_field(); ?>
                <div class="form-group row">
                    <label for="kode_obat" class="col-sm-2 col-form-label">Kode Obat</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control <?= ($validation->hasError('kode_obat')) ? 'is-invalid' : ''; ?>" id="kode_obat" name="kode_obat" value="<?= old('kode_obat'); ?>" autofocus>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="number" class="form-control <?= ($validation->hasError('stok_obat')) ? 'is-invalid' : ''; ?>" id="stok_obat" name="stok_obat" value="<?= old('stok_obat'); ?>">
                        <div class="invalid-feedback">
